...
import com.oop_project.cs212.islamicapp.database.DeleteData;
import com.oop_project.cs212.islamicapp.database.MyDatabase;
import com.oop_project.cs212.islamicapp.interfaces.RetrofitApiCaller;
    ...
    public void download(){
        ...
        athkar.enqueue(new Callback<Athkar>() {
            ...
            public void onFailure(Call<Athkar> call, Throwable t) {
                Log.d(TAG, "onFailure: failed to store data");
                t.printStackTrace();
                alreadyDownloading = false;
